...
public class PasswordAllarme extends JFrame  {
	...
	public PasswordAllarme(JFrame f) {
		//Use the default FlowLayout.
	
		
		setTitle("Password Allarme");
		setSize(400,110);
		...
		getContentPane().add(passwordField, "cell 0 0");
						...
						btnNewButton.setIcon(new ImageIcon(PasswordAllarme.class.getResource("/image/arrow_right.png")));
							...
							public void actionPerformed(ActionEvent e) {
								...
								if (isPasswordCorrect(input)) 
								{
									...
									JOptionPane.showMessageDialog(null,
											"Password Errata",
											"Error Message",
											JOptionPane.INFORMATION_MESSAGE,new ImageIcon(PasswordAllarme.class.getResource("/image/error.png")));
								}
	...
	private static boolean isPasswordCorrect(char[] input) {
		...
		char[] correctPassword = { 'p', 'a', 's', 's', '0', '2', '1', '!' };
